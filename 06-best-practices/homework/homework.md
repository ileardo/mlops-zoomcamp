...
### A1: How does the `if` statement that we use for this looks like? 
...
### A2: What should be the other file?
...
### A3: How many rows should be there in the expected dataframe?
...
### A4: What option do we need to use for such purposes?
...
### A5: What's the size of the file?
...
### A6: What's the sum of predicted durations for the test dataframe?
